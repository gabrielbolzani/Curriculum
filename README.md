...
- **Engenharia de Controle e Automação** – Faculdade UCL (**2024/1**)  
- **Técnico em Automação Industrial** – IFES Serra (**2019/1**)
...
- **Sistemas Embarcados / IoT:** ESP32, Arduino, Raspberry Pi  
- **Infraestrutura & DevOps:** Azure, AWS, Docker, Linux, VPNs  
- **Banco de Dados:** MySQL  
- **Modelagem & Design:** Fusion 360, AutoCAD 2D, Impressão 3D  
- **Eletrônica:** Soldagem **SMD/PTH**, montagem de **PCBs**, prototipagem  
- **Ferramentas:** Git, VS Code, pfSense, VirtualBox, Proxmox  
- **Impressão 3D:** Alto desempenho e aplicações funcionais
